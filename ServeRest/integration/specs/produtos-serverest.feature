...
#GET
        Cenário: Listar produtos cadastrados
             ...
             Então deverá retornar schema "get_produtos" status 200 com a lista de produtos

        Esquema do Cenário: Buscar produto por id
             Quando acessar a rota /produtos/{_id}
              E o produto for "<tipo>"
             Então deverá retornar schema "get_produtos_id" com "<status>" e "<mensagem>"
        Exemplos:
...
#POST
        Esquema do Cenário: Cadastrar produtos
             ...
             Então deverá retornar schema "post_produtos" com "<status>" e "<mensagem>"
        Exemplos:
                  | status | mensagem                            |
...
#DELETE
        Esquema do Cenário: Excluir produto
             ...
             Então deverá retornar schema "delete_produtos" com "<status>" e "<mensagem>"
        Exemplos:
                  | status | mensagem                            |
...
#PUT
        Esquema do Cenário: Editar produto
             ...
             Então deverá retornar schema "put_produtos" com "<status>" e "<mensagem>"
        Exemplos:
                  | status | mensagem                            |
