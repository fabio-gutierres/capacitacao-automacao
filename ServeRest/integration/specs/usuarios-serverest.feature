...
#GET
        Cenário: Listar usuarios cadastrados
             ...
             Então Então deverá retornar schema "get_usuarios" status 200 com a lista de usuarios

        Esquema do Cenário: Buscar usuarios por id
             Quando acessar a rota /usuarios/{_id}
              E o usuario for "<tipo>"
             Então deverá retornar schema "get_usuarios_id" com "<status>" e "<mensagem>"
        Exemplos:
...
#POST
        Esquema do Cenário: Cadastrar usuario
             ...
             Então deverá retornar schema "post_usuarios" com "<status>" e "<mensagem>"
        Exemplos:
                  | status | mensagem             |
...
#DELETE
        Esquema do Cenário: Excluir usuario
             Quando acessar a rota /usuarios/{_id}
              E excluir usuario
             Então deverá retornar schema "delete_usuarios" com "<status>" e "<mensagem>"
        Exemplos:
                  | status | mensagem                        |
...
#PUT
        Esquema do Cenário: Editar usuario
             Quando acessar a rota /usuarios/{_id}
              E editar usuario
             Então deverá retornar schema "put_usuarios" com "<status>" e "<mensagem>"
        Exemplos:
                  | status | mensagem             |
